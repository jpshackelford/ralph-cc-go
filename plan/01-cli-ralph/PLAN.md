...
[ ] Implement the phase plan in `plan/01-cli-ralph/PLAN_PHASE_CMINOR.md`, go incrementally (and run tests as you go). Update phase plan marking your progress and notes if you get stuck. Bail if stuck, mark this complete if you finish. (Milestones 1-5 complete, Milestone 6: CLI Integration & Testing remaining)
